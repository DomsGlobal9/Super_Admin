    ...
    try {
      ...
      setPieData([
        {
          ...
          value:
            totalOrgAndB2C > 0
              ? Math.round((organizationalRevenue / totalOrgAndB2C) * 100)
              : 50,
          color: "#4A90E2",
          percentage: totalOrgAndB2C > 0 ? Math.round((organizationalRevenue / totalOrgAndB2C) * 100) : 50,
        },
        {
          name: "B2C",
          value:
            totalOrgAndB2C > 0
              ? Math.round((b2cRevenue / totalOrgAndB2C) * 100)
              : 50,
          color: "#7BB3F0",
          percentage: totalOrgAndB2C > 0 ? Math.round((b2cRevenue / totalOrgAndB2C) * 100) : 50,
        },
      ]);
      ...
      const sortedVendors = Array.from(vendorRevenueMap.values())
        ...
        .map((vendor) => ({
          ...
          color: vendor.growth.startsWith("+")
            ? "text-green-500"
            : "text-red-500",
        }));
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        <div className="bg-white rounded-lg p-3  shadow-sm ">
          <div className="flex items-center justify-between  mb-2">
            <span className="text-md font-outfit pl-2 text-black">
              Total Revenue
            </span>
          ...
          <div className="text-2xl font-bold pl-2 text-gray-900">
          ...
          <div className="flex flex-col items-center">
              ...
              <ResponsiveContainer width={250} height={200}>
                <PieChart>
                  <Pie
                    ...
                    startAngle={90}
                    endAngle={450}
                    dataKey="value" // This will use the actual revenue values
                    className="focus:outline-none hover:outline-none"
            ...
            <div className="flex justify-center space-x-8 mt-4">
              <div className="text-center">
                ...
                <div className="text-xs text-gray-500">Organizational</div>
              </div>
              <div className="text-center">
        ...
        <div className="bg-white rounded-lg shadow-sm ">
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center justify-between">
              ...
              <button
                className="text-sm text-blue-600 hover:text-blue-700 h-10"
                onClick={() => {
                  navigate("/layout/vendor-management");
                }}
              >
                {" "}
                <span className="flex flex-row text-black gap-2">
                  View All <img src={right_arrow} alt="" className="h-5" />
                </span>
              </button>
            </div>
          </div>
              ...
              {topVendors.length > 0 ? (
                topVendors.map((vendor, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center">
                      <span className={`font-medium text-sm ${vendor.color}`}>
                        {vendor.growth}
                      </span>
                    </div>
                  </div>
              ...
              {recentAlerts.length > 0 ? (
                recentAlerts.map((alert, index) => (
                  <div key={index} className="flex items-start space-x-3">
                    <div
                      className={`w-8 h-8 rounded-full ${alert.bgColor} flex items-center justify-center flex-shrink-0`}
                    >
